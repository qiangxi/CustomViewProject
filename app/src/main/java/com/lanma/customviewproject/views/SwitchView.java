    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mTotalItemCount; i++) {
            ...
            if (i == mSelectedPosition) {
                ...
                drawSelectedItemBackground(canvas, i);
            }
            drawText(canvas, i);
        }
    }

    private void drawSelectedItemBackground(Canvas canvas, int position) {
        ...
        canvas.drawRoundRect(mSelectedItemBound, mSelectedBgRadius, mSelectedBgRadius, mBgPaint);
    }
